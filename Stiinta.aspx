<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Stiinta.aspx.cs" Inherits="Stiinta" %>
       ...
       <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource3">
            ...
            <SelectedItemTemplate>
                ...
                <br />
                    ...
                    <asp:ListView ID="ListView3" runat="server" DataSourceID="SqlDataSource2" Visible="false">
            <AlternatingItemTemplate>
                <span style="">
                <asp:Label ID="TitluLabel" CssClass="titlu" runat="server" Text='<%# Eval("Titlu") %>' />
                <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [Titlu], [Continut], [Autor], [Data_adaugarii] FROM [News]"></asp:SqlDataSource>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [Titlu], [Continut], [Autor], [Data_adaugarii] FROM [News] WHERE ([Categorie] LIKE '%' + @Categorie + '%') ORDER BY [Data_adaugarii] DESC">
               <SelectParameters>
                   <asp:Parameter DefaultValue="Stiinta" Name="Categorie" Type="String" />
               </SelectParameters>
           </asp:SqlDataSource>

        
         <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [Titlu], [Continut], [Autor], [Data_adaugarii] FROM [News] WHERE ([Categorie] LIKE '%' + @Categorie + '%') ORDER BY [Titlu]">
               <SelectParameters>
                   <asp:Parameter DefaultValue="Stiinta" Name="Categorie" Type="String" />
               </SelectParameters>
           </asp:SqlDataSource>
