<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Tehnologie.aspx.cs" Inherits="Tehnologie" %>
    ...
    <section class="sectionhome">
       <div> Sorteaza dupa 
        ...
        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource2">
            ...
            <EmptyDataTemplate>
                <span style="font-size: 20px; padding: 50px;">Nu exista stiri din aceasta categorie.</span>
            </EmptyDataTemplate>
            <InsertItemTemplate>
                <span style="">
          ...
          <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSource1" Visible="false">
           ...
           <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [Titlu], [Continut], [Autor], [Data_adaugarii] FROM [News] WHERE ([Categorie] LIKE '%' + @Categorie + '%') ORDER BY [Data_adaugarii] DESC">
               <SelectParameters>
                   <asp:Parameter DefaultValue="Tehnologie" Name="Categorie" Type="String" />
               </SelectParameters>
           </asp:SqlDataSource>
